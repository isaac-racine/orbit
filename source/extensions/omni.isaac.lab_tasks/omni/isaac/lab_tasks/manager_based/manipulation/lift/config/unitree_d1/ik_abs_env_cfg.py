...
class D1CubeLiftEnvCfg(joint_pos_env_cfg.D1CubeLiftEnvCfg):
    def __post_init__(self):
        ...
        # Set D1 as robot
        # Maybe switch here to a stiffer PD controller for IK tracking to be better. 
...
@configclass
class D1TeddyBearLiftEnvCfg(D1CubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        self.scene.robot.actuators["d1_hand"].effort_limit = 50.0
        self.scene.robot.actuators["d1_hand"].stiffness = 40.0
        self.scene.robot.actuators["d1_hand"].damping = 10.0
