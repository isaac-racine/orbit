...
from ..terrain_generator_cfg import FlatPatchSamplingCfg, TerrainGeneratorCfg
...
for key in CUSTOM_TERRAIN_CFG.sub_terrains:
    CUSTOM_TERRAIN_CFG.sub_terrains[key].flat_patch_sampling = {"target": TARGET_SAMPLING_CFG}
...
NOISE_TERRAIN_CFG = TerrainGeneratorCfg(
    ...
    use_cache=False,
    curriculum=False,
    sub_terrains={"noise": terrain_gen.HfRandomUniformTerrainCfg(noise_range=(0.02, 0.10), noise_step=0.02)},
)
