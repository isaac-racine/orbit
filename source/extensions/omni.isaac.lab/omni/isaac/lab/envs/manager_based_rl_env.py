...
class ModifiedManagerBasedRLEnv(ManagerBasedRLEnv):
    ...
    def load_managers(self):
        ...
        print("[INFO] Termination Manager: ", self.termination_manager)
        # -- reward manager
        self.reward_manager = ModifiedRewardManager(self.cfg.rewards, self)
        print("[INFO] Reward Manager: ", self.reward_manager)
        # -- curriculum manager
        self.curriculum_manager = CurriculumManager(self.cfg.curriculum, self)
        print("[INFO] Curriculum Manager: ", self.curriculum_manager)
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturnModified:
        """Execute one time-step of the environment's dynamics and reset terminated environments.
        ...
        self.reset_time_outs = self.termination_manager.time_outs
        # -- reward computation
        self.reward_buf, self.episode_sum = self.reward_manager.compute(dt=self.step_dt)
