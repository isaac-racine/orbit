...
def pyramid_slope_terrain(
	...
	# fill the holes
	if not cfg.holes:
		quadTR = trimesh.Trimesh(
			vertices=np.array([
				slope_mesh1.vertices[2], slope_mesh1.vertices[0], slope_mesh3.vertices[0], [terrain_size[0]/2, terrain_size[1]/2, 0.0]
			]),
			faces=np.array([[0,1,2], [1,3,2]])
		)
		quadTL = trimesh.Trimesh(
			vertices=np.array([
				slope_mesh2.vertices[0], slope_mesh3.vertices[2], slope_mesh2.vertices[2], [-terrain_size[0]/2, terrain_size[1]/2, 0.0]
			]),
			faces=np.array([[0,1,2], [1,3,2]])
		)
		quadBR = trimesh.Trimesh(
			vertices=np.array([
				slope_mesh1.vertices[3], slope_mesh4.vertices[1], slope_mesh1.vertices[1], [terrain_size[0]/2, -terrain_size[1]/2, 0.0]
			]),
			faces=np.array([[0,1,2], [1,3,2]])
		)
		quadBL = trimesh.Trimesh(
			vertices=np.array([
				slope_mesh2.vertices[1], slope_mesh2.vertices[3], slope_mesh4.vertices[3], [-terrain_size[0]/2, -terrain_size[1]/2, 0.0]
			]),
			faces=np.array([[0,1,2], [1,3,2]])
		)
