...
class CommandTerm(ManagerTermBase):
    ...
    def _resample(self, env_ids: Sequence[int]):
        ...
        self.time_left[env_ids] = math.inf if self.cfg.resampling_time_range[0] == self.cfg.resampling_time_range[1] == math.inf else self.time_left[env_ids].uniform_(*self.cfg.resampling_time_range)
