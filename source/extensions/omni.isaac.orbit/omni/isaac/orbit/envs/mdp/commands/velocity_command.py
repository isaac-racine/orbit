...
class UserVelocityCommand(CommandTerm):
	r"""Command generator that generates a velocity command in SE(2) from user input.
	...
	cfg: UserVelocityCommandCfg
	"""The configuration of the command generator."""

	def __init__(self, cfg: UserVelocityCommandCfg, env: BaseEnv):
		"""Initialize the command generator.
