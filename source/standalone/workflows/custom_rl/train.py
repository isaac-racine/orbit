...
parser = argparse.ArgumentParser(description="Train an RL agent with Custom-RL.")
...
from omni.isaac.lab_tasks.utils.wrappers.custom_rl import CustomRlOnPolicyRunnerCfg, CustomRlVecEnvWrapper
...
def main():
    ...
    runner = OnPolicyRunner(env, agent_cfg.to_dict_ignore(), log_dir=log_dir, device=agent_cfg.device)
